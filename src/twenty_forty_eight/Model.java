...
public class Model {
    ...
    /**
     * instead of writing a lot of code to each keyPress (event up, down, left, right), we can just rotate the field n times (in each method)
     * and call left() method at the right time to reposition the game field (the Tile[][])     *
     */
    ...
    //this method is needed because of the rollBack feature
